        ...
        <>
            <div className="text-justify w-4/12 max-lg:w-screen max-xl:w-7/12">
                <div className="flex flex-col items-center xl:w-full">
                    ...
                    <h2 className="font-Poppins text-lightmode-font-color dark:text-darkmode-font-color text-xl max-md:w-full max-lg:w-9/12 xl:w-11/12">Tenho 18 anos e iniciei minha trajetória com desenvolvimento web aos 16. Atualmente, atuo como desenvolvedor front-end, mas futuramente pretendo me tornar desenvolvedor full-stack.</h2>
                </div>
            </div>
        </>
    )
