function Footer() {
    return (
        <footer className="bg-lightmode-background-color-2 dark:bg-darkmode-background-color-2 flex justify-between items-center p-6">
            <div className="text-lg font-Chakra font-bold text-lightmode-font-color dark:text-darkmode-font-color">&copy;Desenvolvido por Murilo Ceconello</div>
