function Footer() {
    return (
        <footer className="bg-lightmode-background-color-2 dark:bg-darkmode-background-color-2 flex justify-between items-center p-6 max-sm:flex-col max-sm:gap-y-3">
