function Main() {
    return (
        <main>
                ...
                <div className="flex justify-around my-14">
                    ...
                    <div>
                        ...
                        <div className="flex justify-around gap-10">
                            <div className="bg-card-color hover:bg-grey hover:scale-105 hover:shadow-xl p-2 rounded-md transition duration-300">
            ...
            <section id="projetos" className="w-full p-10">
                <h1 className="font-Chakra text-center font-bold text-4xl text-color2 pt-10">Projetos</h1>
                <div>
                    <div className="flex flex-wrap justify-around mt-10">
                        <div className="bg-card-color w-72 h-56 rounded-xl"></div>
                        <div className="bg-card-color w-72 h-56 rounded-xl"></div>
                        <div className="bg-card-color w-72 h-56 rounded-xl"></div>
                    </div>
                    <div className="flex flex-wrap justify-around mt-10">
            ...
            <section id="certificados" className="bg-color2 w-full p-20">
                <h1 className="text-center text-font-color-dark font-Chakra text-4xl font-bold">Certificados</h1>
                <div className="flex flex-warp justify-around mt-10">
                    <div className="bg-card-color w-72 h-48 rounded-xl"></div>
                    <div className="bg-card-color w-72 h-48 rounded-xl"></div>
                    <div className="bg-card-color w-72 h-48 rounded-xl"></div>
                    <div className="bg-card-color w-72 h-48 rounded-xl"></div>
                    <div className="bg-card-color w-72 h-48 rounded-xl"></div>
